...
var a = {
    p: function(q,r,s, imat, bounce, mass, friction, jump, air, isKiller, isDriftOn) {
        ...
        if (!bounce) bounce = 0;
    	maker.make_platform(q,r,s, imat, bounce, mass, friction, jump, air, isKiller, isDriftOn);
    },
    y: function(q,r,s, imat, bounce, mass, friction, air, topr, isKiller) {
        if (!imat) imat = (IS_ICEPARTY) ? 1 : 0;
        if (!bounce) bounce = 0;
        maker.make_cylinder(q,r,s, imat, bounce, mass, friction, air, topr, isKiller);
    },
    s: function(q,radius, imat, bounce, mass, friction, air, isKiller) {
        maker.make_sphere(q, radius, imat, bounce, mass, friction, air, isKiller);
    },
